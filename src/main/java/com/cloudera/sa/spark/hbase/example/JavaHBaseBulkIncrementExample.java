...
public class JavaHBaseBulkIncrementExample {
	public static void main(String args[]) {
		if (args.length == 0) {
		  System.out.println("JavaHBaseBulkIncrementExample  {master} {tableName} {columnFamily}");
		}
		...
		JavaSparkContext jsc = new JavaSparkContext(master, "JavaHBaseBulkIncrementExample");
    ...
    hbaseContext.javaBulkIncrement(rdd, tableName, new IncrementFunction(), 4);
    ...
    public Increment call(String v) throws Exception {
      ...
      increment.addColumn(Bytes.toBytes(cells[1]), Bytes.toBytes(cells[2]), Integer.parseInt(cells[3]));
      return increment;
    }
