...
class HBaseContext(@transient sc: SparkContext,
  ...
  def streamBulkCheckDelete[T](dstream: DStream[T], tableName: String, f: (T) => (Array[Byte], Array[Byte], Array[Byte], Array[Byte], Delete), autoFlush: Boolean) {
    dstream.foreach((rdd, time) => {
   ...
   *
   */
  private class GetMapPartition[T, U: ClassTag](tableName: String,
    batchSize: Integer,
    makeGet: (T) => Get,
